...
class Match:
    ...
    def __init__(self, screen: pygame.Surface, paddle_size: Tuple[int, int] = (50, 100), margin_to_border: int = 30,
                 screen_color: Tuple[int, int, int] = (132, 45, 76), ball_position: Tuple[int, int] = (350, 200)):
        self._screen = screen
        ...
        self._ball = Ball(color=(123, 0, 0), radius=20, center= ball_position, speed=13, screen=screen)
